<?php
    ...
    if( isset($_POST['guardar']) ){
        DB::updateInfo( $_POST['GD'], $_POST['id'], $_SESSION['user_id'], $_POST['tcorrg'] );
    ...
    if ( (int) $_POST['id'] === 1 ){
        ...
        if(  (int) DB::getLowerLimit( $_POST['GD'] , (int) $_POST['id'] ) == 0  ){
            ...
            if( DB::existNextTcorrg( $_POST['GD'] , (int) $_POST['id'] ) ){
                ...
                $tocr = DB::getIDText( $_POST['GD'], (int) $_POST['id'] )[0];
                $tcorrg =  DB::getIDTextCorrg( $_POST['GD'], (int) $_POST['id'] )[0];
                ...
                <div class="card border-secondary " >
                    ...
                    <div class="card-body text-secondary">
                        <div class="form-group">
                            ...
                            <label for="tocr">Corrección: </label>
                                <div class="input-group">
                                    <input  style='background-color:#F6D2AE;' class="form-control"  name="tocr" id="tocr" value='<?php  echo $tcorrg; ?>' autofocus />
                                </div>
                            <br>
                            ...
                            <label> Lineas siguientes OCR:  </label>
                            <div class="input-group">
            ...
            <div class="col-sm-10 col-md-3 ">
                <div class="card border-secondary mb-5">
                    ...
                    <div class="card-body text-secondary ">
                        ...
                        <br>
                        <div class="text-center">
                            <a class="btn btn-warning " href="selectgd.php"  >VOLVER
                            </a>
...
<script type="text/javascript">
    ...
    function copy2() {
        $("#tocr").val(document.getElementById("tsug").value);
    }
